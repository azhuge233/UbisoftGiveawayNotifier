...
Fetch free games info from Ubisoft giveaway page, send notifications through Telegram, Email, Bark, QQ, PushPlus and DingTalk.

Currently I'm not able to find an workable source to get Ubisoft giveaways that only available in certain regions (like the Splinter's cell Double Agent giveaway is Japan only), so the program will not send notifications for any region-specific giveaways.
